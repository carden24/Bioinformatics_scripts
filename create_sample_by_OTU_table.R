...
samples=unique(data$V1)                                                                         # get list of samples
OTUs=unique(data$V2)                                                                            # get list of OTU
output=matrix(data=0,nrow=length(samples),ncol=length(OTUs)) #create empty matrix with zeroes
rownames(output)=samples                                                                        # Change names of rows to sample names
colnames(output)=OTUs                                                                           # Change names of rows to OTU names
